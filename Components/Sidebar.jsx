...
//   const dynamicWidth = showTechnical || showOther ? 'w-[240px]' : 'w-[240px]';
  ...
  return (
    <div className={`h-full w-[250px] bg-blue-100 px-4 shadow-lg p-4 overflow-y-auto pt-14 lg:pt-4 transition-all duration-300`}>
      ...
      <div className="mt-8">
        ...
        {showIssues && (
          <div className="pl-2">
            <div>
              <button className="cursor-pointer w-full text-left mt-2 font-semibold flex justify-between items-center" onClick={() => setShowTechnical(!showTechnical)}>
